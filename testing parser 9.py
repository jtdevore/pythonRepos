...
def repairTimeS(): #Stores user input variable repairSdate for later use
    root = Tk()
    root.withdraw()
    repairTime1 = tkinter.simpledialog.askstring("Enter Repair Start Time", "Enter Repair Start Time")
    print (repairTime1)
    return repairTime1

def repairTimeC(): #Stores user input variable repairSdate for later use
    root = Tk()
    root.withdraw()
    repairTime2 = tkinter.simpledialog.askstring("Enter Repair Complete Time", "Enter Repair Complete Time")
    print (repairTime2)
    return repairTime2
